...
/* =========================================================
   STUDENT VERSION (Exercises 9–16)
   ========================================================= */
...
btnGrade.onclick = function () {
    ...
    if (scoreInput.value === "" || score < 0 || score > 100) {
        grade = "Invalid Score";
    } else if (score >= 90) {
        grade = "A";
    } else if (score >= 80) {
...
btnEvenOdd.onclick = function () {
    ...
    const status = isEven(n) ? "EVEN" : "ODD";
    evenOddOut.innerText = "Result: " + status;
};
...
btnRepeat.onclick = function () {
    ...
    repeatOut.innerText = result.trim();
};
